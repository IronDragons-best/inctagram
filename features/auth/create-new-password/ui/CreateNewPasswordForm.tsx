...
import {
  ...
  InputError,
} from '@/features/auth/create-new-password/lib/schemas/passwordConfirmation';
...
export const CreateNewPasswordForm = () => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<InputError>({resolver: zodResolver(passwordConfirmationSchema), mode: "onBlur"})
  const onSubmitHandler: SubmitHandler<InputError> = (data) => console.log(data);
      ...
      <div className={s.formWrapper}>
        ...
        <form onSubmit={handleSubmit(onSubmitHandler)} className={s.form}>
          ...
          <Input
            ...
            fullWidth={true}
            errorText={errors.confirmationPassword ? "The passwords must match" : ""}
